<?php
if (!@($conexao = pg_connect("host=boavista dbname=postgres port=5432 user=monitoramento password=monitoramento"))) {
...
pg_database.datname;";
  ...
  // echo '<div class="col-xs-12 col-md-2">';
        ...
        echo '<label for="" style="margin-left:5px; color:grey; font-size:10px; ">';
        echo $consulta['datname'];
        echo '</label>';
        echo '</i>';
        echo '</td>';
